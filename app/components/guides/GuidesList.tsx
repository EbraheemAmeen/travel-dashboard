...
export default function GuidesList({
  ...
  const [deleteModal, setDeleteModal] = useState<{ open: boolean; guide: any | null }>({ open: false, guide: null });
  ...
  if (isError) {
    return (
      <div className="p-12 min-h-screen bg-gray-900 text-white">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-red-500 mb-4">Error Loading Guides</h1>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {guides.map((guide: any) => (
            <div key={guide.id} className="bg-gray-800 rounded-lg overflow-hidden border border-gray-700">
              {guide.avatar && (
              ...
              <div className="p-6">
                <div className='h-10 w-10 rounded-full bg-cover bg-center' style={{ backgroundImage: `url(${imagesUrl}${guide.user.avatar})` }}></div>
                <h3 className="text-xl font-bold text-white mb-2">{guide.user.name}</h3>
                ...
                <div className="space-y-2 mb-4">
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="text-white">{guide.user.phone || 'N/A'}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                ...
                <div className="flex gap-2">
                  <Link
                    href={`/cities/${cityId}/guides/${guide.id}/edit`}
        ...
        {deleteModal.open && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-gray-800 rounded-lg p-6 max-w-md w-full mx-4">
              <h3 className="text-xl font-bold text-white mb-4">Delete Guide</h3>
              <p className="text-gray-300 mb-6">
                Are you sure you want to delete "{deleteModal.guide?.name}"? This action cannot be undone.
              </p>
              {deleteError && (
